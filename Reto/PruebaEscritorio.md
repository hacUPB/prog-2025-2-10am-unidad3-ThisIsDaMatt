...
- Condición de vuelo: Si L >= peso entonces "El avión puede volar", si no, no.
...
Constantes:
- 0.5 siempre está en las ecuaciones aerodinámicas para calcular fuerzas.

### Caso de Prueba 1 (Valores Normales)
| Entrada | Valor |
|---------|-------|
| rho | 1.225 |
| V   | 70 |
...
7. Comparar: L (57624) >= peso (12000) = Verdadero.
...
5. L = 15312.5 * CL = 15312.5 * 1.2 = 18375.0
...
### Conclusión
La logica que propusimos y las ecuaciones usadas satisfacen todos los casos que probamos para el codigo. (suficiente sustentación, insuficiente sustentación y caso límite con Peso = L).
