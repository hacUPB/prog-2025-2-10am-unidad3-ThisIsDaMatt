...
| Requisito | Calificación | Evidencia (página/tabla/sección) |
|-----------|-------------|--------------------------------|
| Contexto aeronáutico claro y relevante |2 |Los tres problemas tratan de lo siguiente: El primero trata sobre el calculo sobre la sustentación y el arrastre de una aeronave. El segundo trata sobre el analisis de combustible de una aeronave y un calculo de cuantas horas podria volar una aeronave; el tercero trata sobre la simulación de abordaje a una aeronave en un aeropuerto. |
| Clara definición y clasificación de las variables de entrada, salida, de control e intermedias |1 |En el codigo están bien estructuradas pero faltan algunos datos. |
